  ...
  const question = (page) => {
    switch (page) {
      ...
      case 5:
        ...
        `
      case 6:
        return `Would you like to play a game with a stylized, cartoony, or animated graphical style?`
      case 7:
      ...
      case 13:
        return `Do you find the most enjoyment in feeling unrestricted and free to explore, or in having a sense of direction?`
      case 14:
        return `Would you like to play a game with a strong focus on story, character, and narrative?`
      case 15:
