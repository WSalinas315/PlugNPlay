    ...
    return (
      <div>
        ...
        <Card sx={{ textAlign: 'center', border: '1px solid #C02222' }}>
          ...
          {/* Games played count */}
          <h3>Played Games: {userLists.userPlayedList.length}</h3>
          {/* Wishlisted games count */}
          <h3>Games on Wishlist: {userLists.userPlayedList.length}</h3>
          {/* Bartle Player Type */}
          {/* <ProfileBartleType /> */}
    ...
    return (
      <div>
        ...
        <Card sx={{ textAlign: 'center', border: '1px solid #C02222' }}>
          ...
          <h3>Played Games: {userLists.userPlayedList.length}</h3>
          {/* Wishlisted games count */}
          <h3>Games on Wishlist: {userLists.userWishlist.length}</h3>
          {/* Bartle Player Type */}
          {/* <ProfileBartleType /> */}
          <h3>Player Type: Killer (Placeholder)</h3>
          <LogOutButton />
