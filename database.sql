...
INSERT INTO "survey_questions"
	...
	'"Immersion" is one of the most difficult game terms to define. In short, some games strive to really place you in the main character''s shoes, and to create a game world that feels wondrous and alive. Others let you take more of a bird''s eye view of events, or place some distance between the character and the player (sometimes literally, as in your field of view, and sometimes in how you relate to the character).',
	array[]::text[],
	array[]::text[],
	...
	'Fast-paced games would include first-person shooters, platformers, and racing games; slower-paced games would include strategy games, and games with turn-based combat (where you take turns with the computer-controlled enemies).',
	...
	'The narrative tone of games can vary immensely, and the subject matter of some games can skew distinctly macabre. These games can be very compelling and thought-provoking, but it''s ok if you''d like to focus on having a good time when you play.',
	array[]::text[],
	array[]::text[],
